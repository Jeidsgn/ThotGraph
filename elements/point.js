export class Point {
  constructor(scene) {
    ...
    this.selectedPoints = scene.add.group(); // Grupo para almacenar los puntos seleccionados en la escena
    ...
    this.scene.input.on("pointerup", () => {
      ...
      this.selectedPoints.clear(true, true); // Limpia el grupo de puntos seleccionados
    });
  }
